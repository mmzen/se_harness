...
| [Proposal: installation through Codex and Claude Code plugins, 2026-09-06](plugin-installation-proposal-2026-09-06.md) | How would a plugin bundle harnessctl and Python, add three skills and a hook handler, and preserve the existing authority boundaries? Revised 2026-09-08. |
