...
| [Plugin definition delivery, 2026-09-08](plugin-definition-delivery-2026-09-08.md) | Which eleven groups deliver the 16 packets with complete references, one selected work order per PR, and explicit approval prerequisites? |
...
| [Assessment of the plugin proposal, 2026-09-08](assessment-plugin-proposal-2026-09-08.md) | How sound is the plugin proposal and its 16 packets, what became of the PR #360 review findings, which three things block approving any work order, and how does each axis score from 0 to 10? (point-in-time, PR #416 at `3575f727`, reassessed at `c5c3c7c4`, proposal) |
