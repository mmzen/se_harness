...
| [RCA: merge without required verification, 2026-09-04](../rca/2026-09-04-merge-authorization-boundary.md) | Why did PR #344 merge without a VREC decision, and which deterministic controls must enforce the authorization boundary? |
...
| [Proposal: a remote governance service, 2026-09-07](proposal-remote-governance-service-2026-09-07.md) | Should the artifacts and the workflow rules move from the governed repository to a remote service behind the binary, what would that gain and break, and what thinner service gets the gains while the ledger stays in Git? (point-in-time, `711fe39c`, proposal and four owner decisions) |
...
| [Assessment of intent readability, 2026-09-04](assessment-intent-readability-2026-09-04.md) | How long, dense and consistent are the 33 intents for the reader who meets them first, do their success measures outlive the work order, which standards apply, and what shorter template, outcome field, advisories and migration would help? (point-in-time, `09047aa`, proposal) |
...
| [Assessment of specification readability, 2026-09-06](assessment-specification-readability-2026-09-06.md) | How long, dense and consistent are the 135 specifications, how are their rules identified and cited, and what would make a rule one testable, addressable sentence; measured on `main` at `aad82a9` under the 0.15.0 root, with a proposal and four owner decisions. |
| [One execution route](delegation-class.md) | What does work-order approval let its executor do, and which scope, assurance and delivery decisions remain with the owners? |
| [Assessment of the delegated route, 2026-09-07](assessment-delegated-route-2026-09-07.md) | How do the human and the delegated routes differ step by step, how often has the class been used since it shipped, and is it worth keeping? (point-in-time, `1fa0610b`, verdict and three follow-ups) |
...
| [Risk artifacts](risk-artifacts.md) | How does a threat to governed work become a measured artifact whose paired decision stops the threatened stage until an owner answers? |
