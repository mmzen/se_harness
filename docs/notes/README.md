...
- **Repository-specific control:** [`docs/engineering/REPOSITORY_CONTEXT.md`](../engineering/REPOSITORY_CONTEXT.md), product artifacts, build commands, Git strategy, hosting controls, and local agent instructions belong to the repository and its accountable owners.
