...
id = "REQ-PLG-008"
type = "requirement"
title = "Activate the shared integration through Codex"
status = "approved"
owners = ["requirements-steward"]
created = "2026-09-08"
updated = "2026-09-10"
statement = "WHEN a supported Codex session activates the plugin, THE CODEX ADAPTER SHALL connect discovered skills and supported host events to the selected shared implementation."
...
# Requirement: Activate the shared integration through Codex

## In plain words

Codex exposes the shared skills and sends supported events to their handlers. Its integration files do not redefine engineering rules.

## Why

The working activation sequence must become a maintained adapter without creating another workflow engine.

## Behavior

| Trigger | Response | On failure |
| --- | --- | --- |
| Plugin activation on an accepted Codex version and platform | Expose shared skills and connect supported events using the accepted compatibility sequence. | Report failed activation or unsupported events without claiming readiness. |
