...
Derive expected observations from SPEC-PLG-004 and the exact host documentation assessed.
...
| --- | --- | --- | --- |
| REQ-PLG-007 | Demonstration, inspection | Repeated activation; missing Python; inactive event | Every assessed combination has reproducible actions and evidence of activation or a precise incompatibility. |

## Acceptance scenarios

Attempt discovery and new-session activation in a disposable Claude Code profile.
...
Retain fixture revision, referenced documentation, ordered actions, event transcripts, and compatibility table under `evidence/WO-PLG-004/`.

## Residual uncertainty

A documented incompatibility can satisfy this investigation.
Production support remains undecided until DEC-PLG-002; absent evidence cannot authorize a production adapter.
