# WO-PLG-005: delegated execution preparation
...
- Reserve VREC-PLG-012 and its evaluator sidecar as exact future output paths.
...
DEC-PLG-001 accepts Codex CLI 0.153.4 on Windows with Python 3.14.6 and evaluator
...
VER-PLG-005 requires C01-C12, including real-host timeout, startup failure,
