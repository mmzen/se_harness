        ...
        if thread_id:
            ...
            if args.tool_setup_probe:
                ...
                text = ('This is the operator-authorized disposable Codex plugin bootstrap test. '
                    'Use your ordinary shell tool to run these two exact commands, separately and in order, '
                ...
                outcome['tool_attempt'] = {'provided_python': str(provided), 'wheel': str(wheel),
                    ...
                    'permissions': 'ordinary workspace-write/on-request; no automatic approval'}
