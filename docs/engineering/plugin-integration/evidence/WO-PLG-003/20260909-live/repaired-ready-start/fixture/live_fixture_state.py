...
def main():
    ...
    parser.add_argument('--action', choices=['prepare', 'change-source', 'remove', 'restore', 'add-readiness-inputs'], required=True)
    ...
    runtime = data / ('tool-environment' if args.tool_environment else 'environment')
