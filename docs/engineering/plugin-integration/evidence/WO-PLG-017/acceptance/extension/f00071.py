...
OUT=BASE/'attempt2';OUT.mkdir(exist_ok=False)
SRC=BASE.parent/'se-harness-plugin-evidence-path-fix'
PREV=BASE.parent/'plugin-path-repair-independent-20260911'
...
payload=git('03-original-payload','cat-file','blob',commit+':'+row['original_path'])
