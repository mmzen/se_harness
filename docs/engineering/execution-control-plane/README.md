...
- `REQ-ECP-032`: every harnessctl failure follows the stated exit-code and one-code-per-line rules (issue #375, wave 0 of the code health assessment of 2026-09-07; drafted 2026-09-07 with `SPEC-ECP-021`, `VER-ECP-023` and `WO-ECP-027`).
- `REQ-ECP-033`: the shipped surface carries no dead code, dormant command or unreachable contract entry (issue #376, wave 1 of the code health assessment of 2026-09-07, with the owner decisions of issue #381; drafted 2026-09-07 with `SPEC-ECP-022`, `VER-ECP-024` and `WO-ECP-028`, `WO-ECP-029`, `WO-ECP-030`).
...
- `WO-ECP-026` independent; the merged installation command under `REQ-ECP-031` / `SPEC-ECP-020` / `VER-ECP-022`, drafted 2026-09-06 from the functional assessment's combine table and the owner's request of 2026-09-05; no architecture relation, as `WO-ECP-025`. Approved 2026-09-06 (PR #359, merged 9598859), started 2026-09-06 on the owner's words 'merged you can start'; executes on `wo/ecp-026-merge-init-adopt`; two scope amendments of 2026-09-06 (`tests/test_public_onboarding.py`; `se_harness/candidate_acceptance.py` with a one-release alias window for `adopt`, because the released 0.15.0 verifier's acceptance invokes it). Follow-up: remove the alias after 0.16.0 is adopted (`REQ-ECP-030`). Implemented 2026-09-06 ('you can mark as implemented and prepare the verification record'); `VREC-ECP-030` prepared by the assurance owner, awaiting verification.
- `WO-ECP-027` independent; wave 0 correctness under `REQ-ECP-032` / `SPEC-ECP-021` / `VER-ECP-023`, drafted 2026-09-07 from issue #375 (code health assessment); no architecture relation, as `WO-ECP-025`. Approved 2026-09-07 ('i approve', PR #382, merged 1fa0610), started 2026-09-07 on the owner's words 'merged you can start'; executes on `wo/ecp-027-wave0-correctness`. Implemented 2026-09-07 ('implemented'); `VREC-ECP-031` prepared by the assurance owner, awaiting verification.
- `WO-ECP-028`, `WO-ECP-029`, `WO-ECP-030` independent of one another; wave 1 deletions under `REQ-ECP-033` / `SPEC-ECP-022` / `VER-ECP-024`, drafted 2026-09-07 from issue #376: group A dead code and hygiene, group B the `adopt` alias, group C the dormant surface and the two unreachable contract entries (the latter edits candidate template copies, felt on this root at the next adoption); no architecture relation. Approved 2026-09-07 ('i approve', PR #385, merged as #386, #387, #388). `WO-ECP-029` started 2026-09-07 on the owner's words 'merged you can start'; executes on `wo/ecp-029-adopt-alias`. Implemented 2026-09-07 ('implemented'); `VREC-ECP-032` prepared by the assurance owner, awaiting verification. `WO-ECP-028` and `WO-ECP-030` started 2026-09-07 on the owner's words 'you can start both'; they execute on `wo/ecp-028-cleanup` (PR #393) and `wo/ecp-030-dormant` (PR #392). `WO-ECP-030` implemented 2026-09-07 ('you can mark as complete both'); `VREC-ECP-033` verified 2026-09-07 ('i verify both'); merged as PR #392. `WO-ECP-028` and `WO-ECP-030` started 2026-09-07 on the owner's words 'you can start both'; they executed on `wo/ecp-028-cleanup` (PR #393) and `wo/ecp-030-dormant` (PR #392). `WO-ECP-028` implemented 2026-09-07 ('you can mark as complete both'); `VREC-ECP-034` verified 2026-09-07 ('i verify both').
- `WO-ECP-031`, `WO-ECP-032`, `WO-ECP-033` independent of one another; wave 2 primitives under `REQ-ECP-034` / `SPEC-ECP-023` / `VER-ECP-025`, drafted 2026-09-08 from issue #377 (code health assessment 2026-09-07, section 2.1 and the wave 2 plan) and the owner decision of issue #381 item 4: group A the process launcher and the front-matter parser, group B the integrity primitives, the closed sets and the two grammars, group C the diagnostic-code registry and the four contract tables read at run time; the engine's copies stay for wave 3 (#378); no architecture relation. Approved 2026-09-08 ('Approve all six', PRs #395, #396, #397). `WO-ECP-031` started, implemented and `VREC-ECP-035` prepared 2026-09-08 on `wo/ecp-031-process-front-matter` (PR #398); `DEC-ECP-001` (the import barrier keeps `repository_tools` out of the four rules) disposed `amend` by the technical owner and recorded on `SPEC-ECP-023`. `WO-ECP-032` started, implemented and `VREC-ECP-036` prepared 2026-09-08 on `wo/ecp-032-integrity-primitives` (PR #399), its scope amended for `se_harness/preflight.py`. `WO-ECP-033` started 2026-09-08 on `wo/ecp-033-codes-contract-tables` (PR #400); `SPEC-ECP-006` carries the `ECP-PRM-026` amendment record for `agentic_operations`.
- `WO-ECP-034`, `WO-ECP-035`, `WO-ECP-036` in order, the first unblocking the other two; wave 3 engine under `REQ-ECP-035` / `SPEC-ECP-024` / `VER-ECP-026`, drafted 2026-09-08 from issue #378 (code health assessment 2026-09-07, sections 2.1, 2.2, 3.6 and the wave 3 plan) and the revisit triggers of `DEC-ECP-001` and `DEC-ECP-002`: group A the engine as an import surface and its five twins folded into the package, group B one validation per governance command, group C the validator, the generator and the compliance module split along their seams; `SPEC-DST-025` receives the amendment record for `DST-ENG-003` and `DST-ENG-006` under group A; no architecture relation. Approved 2026-09-08 ('Approve all six', PRs #404, #405, #406). `WO-ECP-034` started 2026-09-08 on the owner's word 'start', on `wo/ecp-034-engine-import-surface` (PR #407); amendment records on `SPEC-DST-025`, `SPEC-ECP-021` and `SPEC-IAR-008`; the duplication scan reads 0 blocks at its head, so `ECP-PRM-027` of `SPEC-ECP-023` is met and `DEC-ECP-002`'s revisit arrives with its merge. `WO-ECP-034` implemented and `VREC-ECP-038` prepared 2026-09-08 ('Complete, prepare the record, start group B'); its scope amended for `se_harness/workflow_procedures.py`. `WO-ECP-035` started 2026-09-08 on `wo/ecp-035-one-validation` (PR #412), stacked on the group A branch; `SPEC-ECP-005` carries the `ECP-KRN-007` amendment record. `WO-ECP-035` implemented and `VREC-ECP-039` prepared 2026-09-08 ('Complete, prepare the record, start group C'). `WO-ECP-036` started 2026-09-08 on `wo/ecp-036-seams` (PR #414), stacked on the group B branch; the validator's eight seams, the generator's two and the compliance module's three become modules, `repository_graph.py` and `workflow_edges.py` hold the workflow's graph and edge names, and `SPEC-ECP-023` carries the `ECP-PRM-008` amendment record. `WO-ECP-036` implemented 2026-09-08 ('Complete, prepare the record, start group C') and `VREC-ECP-040` verified the same day ('i verify all 3 verification records', with `VREC-ECP-038` and `VREC-ECP-039`); #407, #412 and #414 merged 2026-09-08 and issue #378 closed with the wave summary.
- `WO-ECP-037` independent; the `DEC-ECP-002` revisit recorded on `SPEC-ECP-023` and on the decision, and this index closed for wave 3, under `REQ-ECP-034` / `SPEC-ECP-023` / `VER-ECP-025`, drafted 2026-09-09 on the owner's words 'go DEC-ECP-002 revisit note'; commit-bound verification `not_required`: two dated records and one index line, the reading being the one the wave 3 records retain (the duplication scan at 0 blocks since `WO-ECP-034`).
- `WO-ECP-038` independent; the `canonical_json_bytes` alias of `release_build` retired, the replay lane script reading `recipe_json_bytes` as `ECP-PRM-009` named it, under `REQ-ECP-034` / `SPEC-ECP-023` / `VER-ECP-025`, drafted 2026-09-09 on the owner's words 'ok go' after `WO-ECP-032`'s disclosure 2 left it to a later work order; commit-bound verification `not_required`: a name, not a byte of output, exercised by the two hosted lanes that run the script.
