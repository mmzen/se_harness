...
- `WO-ECP-027` independent; wave 0 correctness under `REQ-ECP-032` / `SPEC-ECP-021` / `VER-ECP-023`, drafted 2026-09-07 from issue #375 (code health assessment); no architecture relation, as `WO-ECP-025`. Approved 2026-09-07 ('i approve', PR #382); awaits the owner's merge and start decision.
