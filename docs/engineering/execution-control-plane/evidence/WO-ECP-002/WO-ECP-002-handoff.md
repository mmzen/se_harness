...
Pull request #250 at `2b1655d`: all 13 lanes pass, both platform legs of the suite included (the allocation and packet tests run against real `git init` fixtures on Windows and Linux; the managed lane read the body generated by `pr-body`).
