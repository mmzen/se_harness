...
rejected_at = "2026-08-26T09:49:24Z"
rejected_by = "release-owner"
rejection_reason = "Rejected by the accountable release owner on 2026-08-26 because this contract's own declared stop condition occurred. REL-SEH-015 froze a thirty-six-work-order allow-list at 2026-08-25T12:57:58Z and stated that a work order reaching implemented with bytes in the packaged surface after that timestamp is a stop condition whose only remedy is rejection and re-issue as REL-SEH-016, with no in-place correction to gates. Two occurred, neither the anticipated WO-AEX-006, still unmerged on pull request #155: WO-RLO-006 at 2026-08-25T20:22:47Z and WO-REB-023 at 2026-08-26T06:47:01Z, verified by VREC-RLO-006 binding c8b3693 and VREC-REB-020 binding 0ea54d1, both merged into main at e98b788 as true merges of pull requests #167 and #168. Their bytes are in the packaged surface, measured rather than inferred: tests/test_publication_rehearsal.py +352, tests/test_governance_migration.py +129/-9 and tests/test_standard_repository_lifecycle.py +4/-1, a total of +485/-10 distributed lines, confirmed present in an explicitly non-promotable ephemeral sdist built outside the checkout. Successor REL-SEH-016 carries the re-measured thirty-eight-gate unit: 38 work orders, 21 verification contracts, 48 requirements and 41 keyed evidence paths on the whole-gates basis. Every lifecycle event recorded here is preserved unrewritten, including the release owner's real approval at 2026-08-25T12:57:58Z, and no approved allow-list was widened, narrowed or repaired in place. This contract named no release contract in WO-RLS-011's relations and WO-RLS-011 names none in return, so this rejection orphans nothing and needs no successor work order; WO-RLS-011's approval stands and its stale exact-candidate reading is disclosed in REL-SEH-016. Nothing was started here: no promotable build, no candidate commit, no version identity moved on main. This rejection does not approve REL-SEH-016, which needs the release owner's own separate decision."
[relations]
...
from = "approved"
to = "rejected"
decided_at = "2026-08-26T09:49:24Z"
decided_by = "release-owner"
reason = "Rejected by the accountable release owner on 2026-08-26 because this contract's own declared stop condition occurred. REL-SEH-015 froze a thirty-six-work-order allow-list at 2026-08-25T12:57:58Z and stated that a work order reaching implemented with bytes in the packaged surface after that timestamp is a stop condition whose only remedy is rejection and re-issue as REL-SEH-016, with no in-place correction to gates. Two occurred, neither the anticipated WO-AEX-006, still unmerged on pull request #155: WO-RLO-006 at 2026-08-25T20:22:47Z and WO-REB-023 at 2026-08-26T06:47:01Z, verified by VREC-RLO-006 binding c8b3693 and VREC-REB-020 binding 0ea54d1, both merged into main at e98b788 as true merges of pull requests #167 and #168. Their bytes are in the packaged surface, measured rather than inferred: tests/test_publication_rehearsal.py +352, tests/test_governance_migration.py +129/-9 and tests/test_standard_repository_lifecycle.py +4/-1, a total of +485/-10 distributed lines, confirmed present in an explicitly non-promotable ephemeral sdist built outside the checkout. Successor REL-SEH-016 carries the re-measured thirty-eight-gate unit: 38 work orders, 21 verification contracts, 48 requirements and 41 keyed evidence paths on the whole-gates basis. Every lifecycle event recorded here is preserved unrewritten, including the release owner's real approval at 2026-08-25T12:57:58Z, and no approved allow-list was widened, narrowed or repaired in place. This contract named no release contract in WO-RLS-011's relations and WO-RLS-011 names none in return, so this rejection orphans nothing and needs no successor work order; WO-RLS-011's approval stands and its stale exact-candidate reading is disclosed in REL-SEH-016. Nothing was started here: no promotable build, no candidate commit, no version identity moved on main. This rejection does not approve REL-SEH-016, which needs the release owner's own separate decision."
+++
