...
- `REPOSITORY_CONTEXT.md` and `docs/engineering/README.md` are installed as owner-owned seeds and tracked by presence rather than content digest after installation.
