...
This ready record binds retained evidence for `WO-WEX-001` to candidate commit `b32d42469d5cab7bdd0542124021b80ef4588d10`. An accountable assurance owner must review the evidence and transition the record to `verified`; this command did not approve, commit, tag, release, or publish anything.
