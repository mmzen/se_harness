...
This ready record binds retained evidence for `WO-WEX-001` to candidate commit `71bb61e8f25e6a6950e4a303340bab60717a3046`. An accountable assurance owner must review the evidence and transition the record to `verified`; this command did not approve, commit, tag, release, or publish anything.
