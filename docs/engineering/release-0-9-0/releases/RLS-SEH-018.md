...
released_at = "2026-08-28T22:36:24Z"
...
from = "ready"
to = "released"
decided_at = "2026-08-28T22:36:24Z"
decided_by = "release-owner"
reason = "Released on 2026-08-28 by the accountable release owner, 'release RLS-SEH-018'. Re-measured immediately before this transition, every check run before this reason was written: candidate commit 8adfe1b is an ancestor of the branch tip with a clean worktree; VREC-SEH-018 is verified and binds the same candidate; the record's bound wheel c4b5617585a3cb908a3b3c14b97e1039824ca731b8acce0251888d095927f364 and sdist da80ef011572a2b0b96d1bdb920149b97014d9bb5a33de77721054188408268c equal the retained bundle manifest's, which binds the same candidate; the hosted release-candidate-replay dispatch on this review ref (run 33216956619) completed success, rebuilding the bound recipe twice without credentials. Two refusals preceded this application and were each measured: prepare-release had recorded the personal preparation-actor name where the schema wants the accountable role (owners and prepared_by aligned to the role form RLS-SEH-017 uses), and a ready record must omit authorized_by, which this transition itself records. One lane is red at this head by the known pre-merge condition, measured in its log: the release-record rehearsal expects exactly one RLS-SEH-018 at main head and finds 0 until this pull request merges, exactly as RLS-SEH-017 behaved; every other lane passes. Releasing authorizes the publication sequence of REL-SEH-020's promotion policy; the tag, the GitHub Release, PyPI, Pages and the maintenance line remain the separately dispatched last mile, and the pypi environment remains a separate human approval."
+++
