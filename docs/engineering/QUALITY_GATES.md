...
| `QG-G5-RELEASE-PREPARATION` | `QGP-G5P-GRAPH`, `QGP-G5P-INTEGRITY`, `QGP-G5P-RELEASE-UNIT`, `QGP-G5P-DECISION` |
...
| definition (release contract) | `approved` | `QGP-G5P-GRAPH`, `QGP-G5P-INTEGRITY`, `QGP-G5P-RELEASE-UNIT`, `QGP-G5P-DECISION` | `QGS-EDGE` |
