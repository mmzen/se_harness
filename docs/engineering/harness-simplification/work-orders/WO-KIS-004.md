...
paths = [
  ...
  "docs/engineering/harness-simplification/evidence/WO-KIS-004/",
  ...
  "docs/engineering/harness-simplification/verification-records/VREC-KIS-004.evaluator-evidence.json",
  "docs/engineering/harness-simplification/verification-records/VREC-KIS-004.md",
...
Run after WO-KIS-003 implementation is integrated. Rebase and use the current approved shared contract; avoid simultaneous edits of shared modules.
...
| --- | --- | --- |
| KISS-23 | Combining verified work requires all records to name one exact commit | KIS-CUT-023 / K23 |
| KISS-24 | A rebase can orphan a ready record even when the relevant code is unchanged | KIS-CUT-024 / K24 |
| KISS-30 | Release census turns commit trailers into release prerequisites | KIS-CUT-030 / K30 |
| KISS-38 | Human-facing response text is part of a checksum protocol | KIS-CUT-038 / K38 |
...
Read this work order, INT-KIS-001, CAP-KIS-001, REQ-KIS-004, SPEC-KIS-001, VER-KIS-001 and the selected architecture/ADR when listed.
...
The reserved VREC-KIS-004 paths authorize later preparation only; no verification record or result is created by this packet.
