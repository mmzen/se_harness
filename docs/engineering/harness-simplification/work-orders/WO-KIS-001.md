...
paths = [
  ...
  "docs/engineering/harness-simplification/evidence/WO-KIS-001/",
  ...
  "docs/engineering/harness-simplification/verification-records/VREC-KIS-001.evaluator-evidence.json",
  "docs/engineering/harness-simplification/verification-records/VREC-KIS-001.md",
  "docs/engineering/harness-simplification/verification/VER-KIS-001.md",
  "docs/engineering/harness-simplification/work-orders/WO-KIS-001.md",
  ...
  "tests/test_authoring_gate.py",
  "tests/test_cli_shape.py",
  "tests/test_compatibility_windows.py",
  "tests/test_decision_management.py",
  "tests/test_instruction_architecture.py",
  "tests/test_managed_template_texts.py",
  "tests/test_reader_first_capabilities.py",
  "tests/test_reader_first_intents.py",
  "tests/test_reader_first_requirements.py",
  "tests/test_reader_first_specifications.py",
...
Merge this approved definition packet before delegated execution under the installed DR-015 rule.
...
| --- | --- | --- |
| KISS-01 | Windows line endings reject a valid PR declaration | KIS-CUT-001 / K01 |
| KISS-02 | A byte budget fails identical owner instructions | KIS-CUT-002 / K02 |
| KISS-03 | Literal filenames are treated like unsafe patterns | KIS-CUT-003 / K03 |
| KISS-07 | A handoff note needs an exact machine header | KIS-CUT-007 / K07 |
| KISS-11 | Checks require the caller to understand internal procedure names | KIS-CUT-011 / K11 |
| KISS-35 | A requirement must literally contain SHALL | KIS-CUT-035 / K35 |
| KISS-36 | Writing advice is implemented as a detailed grammar engine | KIS-CUT-036 / K36 |
| KISS-37 | Recording a risk demands a scoring and sentence format | KIS-CUT-037 / K37 |
...
This first work order also transports the complete approved definition packet for all seven work orders; the other implementation scopes remain separately selected.
...
Read this work order, INT-KIS-001, CAP-KIS-001, REQ-KIS-001, SPEC-KIS-001, VER-KIS-001 and the selected architecture/ADR when listed.
...
The reserved VREC-KIS-001 paths authorize later preparation only; no verification record or result is created by this packet.
