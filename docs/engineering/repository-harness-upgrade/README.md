...
- `REQ-HUP-027`, `REQ-HUP-028`, `SPEC-HUP-014`, `ARCH-HUP-011` (no significant decision) and `VER-HUP-014` are drafted for the adoption of exact public 0.13.0 (`RLS-SEH-022`, wheel `1bbf3b74…`, payload `9b4cdb5f…`) as the standard root the simple way, from the 0.12.0 lock `4d8f9d37…`, deriving from `CAP-HUP-002`; `WO-HUP-014` is drafted (2026-09-02). Rehearsed on a throwaway clone of `main` at `09aa69f`: 5 managed updates (the two Explorer scripts among them), replay 46 unchanged, 0.13.0 validate 0 errors / 67 warnings / 0 advisories, doctor 0 FAIL, released-root 113/113, the designed Explorer generated identically twice; the candidate moves to `0.14.0` (`PRE008` otherwise). Approval, start, the transaction, completion, verification and merge are separate acts.
