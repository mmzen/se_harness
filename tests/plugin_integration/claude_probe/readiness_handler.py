...
try:
    ...
    observation = {'identity_exit': identity_call.returncode, 'identity': {'passed': False},
                   'identity_observer_stdout': identity_call.stdout, 'identity_observer_stderr': identity_call.stderr}
