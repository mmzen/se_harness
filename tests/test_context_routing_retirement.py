...
PERMITTED_MENTIONS = {
    ...
    "docs/engineering/repository-harness-upgrade/evidence/WO-HUP-002-verification.md": "retained evidence for the root adoption",
    "docs/engineering/repository-harness-upgrade/evidence/WO-HUP-003-verification.md": "retained evidence for post-adoption compatibility",
    "docs/engineering/repository-harness-upgrade/intent/INT-HUP-002.md": "root-adoption intent",
    "docs/engineering/repository-harness-upgrade/README.md": "packet index recording the root adoption",
    "docs/engineering/repository-harness-upgrade/requirements/REQ-HUP-006.md": "owner-preservation requirement",
    "docs/engineering/repository-harness-upgrade/specifications/SPEC-HUP-002.md": "root-adoption specification",
    "docs/engineering/repository-harness-upgrade/verification/VER-HUP-002.md": "root-adoption verification contract",
    "docs/engineering/repository-harness-upgrade/verification/VER-HUP-003.md": "post-adoption compatibility verification contract",
    "docs/engineering/repository-harness-upgrade/work-orders/WO-HUP-001.md": "historical work order",
    "docs/engineering/repository-harness-upgrade/work-orders/WO-HUP-002.md": "root-adoption work order",
