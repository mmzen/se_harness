...
class FixtureSupportTests(unittest.TestCase):
    def test_copies_are_byte_identical_to_a_direct_init_and_init_runs_once(self) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            # 41 installed files and the lock: WO-ECP-006 retired the three writing skills (15 files);
            ...
            # WO-RSK-010 (SPEC-RSK-010 RSK-MGT-001) added the risk template (one file).
            self.assertEqual(42, len(_tree(first)))
