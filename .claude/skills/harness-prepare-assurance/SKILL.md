...
metadata:
  ...
  canonical-name: harness-prepare-assurance
  canonical-path: .agents/skills/harness-prepare-assurance
---
...
1. Resolve the fixed directory
   `${CLAUDE_PROJECT_DIR}/.agents/skills/harness-prepare-assurance`. Do not
